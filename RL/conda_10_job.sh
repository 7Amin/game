...
#SBATCH --job-name=AxialAttentionWithoutPosition_SpaceInvaders-v4
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
PYTHONPATH=. python3 runner.py -m "AxialAttentionWithoutPosition" -u 24 -g "SpaceInvaders-v4" -b 8
